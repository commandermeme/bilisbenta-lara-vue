...
/* harmony import */ var _store_store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../store/store */ "./resources/store/store.js");
...
var routes = [{
  ...
  name: 'Logout',
  component: function component() {
    return __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ../views/Logout.vue */ "./resources/js/views/Logout.vue"));
  }
}, {
  path: '/dashboard',
  name: 'Dashboard',
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  actions: {
    ...
    retrieveToken: function retrieveToken(context, credentials) {
      return new Promise(function (resolve, reject) {
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/auth/login', {
    ...
    destroyToken: function destroyToken(context) {
      ...
      if (context.getters.loggedIn) {
        return new Promise(function (resolve, reject) {
          axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/auth/logout').then(function (response) {
